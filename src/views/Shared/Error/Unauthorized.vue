<template>
	<div class="card">
		<div class="card-body text-center d-flex flex-column flex-center py-15 px-10 py-lg-15 px-lg-15"
			...
			<div class="fw-semibold fs-6 text-gray-500 mb-9">You don't belong here...</div>
			<div class="mb-9">
				<img src="@/assets/media/auth/401.png" class="theme-light-show" style="width:80%; max-width: 320px" />
